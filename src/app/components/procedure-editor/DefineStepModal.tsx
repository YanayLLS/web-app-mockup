...
export function DefineStepModal({ onConfirm, onClose, actionName }: DefineStepModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-[rgba(0,0,0,0.95)] border border-[#36415d] rounded-lg w-full max-w-[500px] shadow-2xl">
        {/* Header */}
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[rgba(255,255,255,0.1)] text-white border border-[#36415d] rounded-lg px-4 py-3 text-[14px] outline-none focus:border-white transition-colors"
              autoFocus
            />
          </div>
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 p-4 border-t border-[#36415d]">
          <button
            onClick={onClose}
            className="bg-[rgba(255,255,255,0.1)] text-white px-6 py-2 rounded-lg hover:bg-[rgba(255,255,255,0.2)] transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={handleConfirm}
            className="bg-[#2f80ed] text-white px-6 py-2 rounded-lg hover:bg-[#2570d0] transition-colors"
          >
            Create Step
          </button>
        </div>
